...
class FileManager:
    ...
    def _process_json_item(self, task, data):
        try:
            ...
            print(f"[ERROR] Failed to process JSON item: {str(e)}")
    ...
    def get_file(self, task, user_identifier, thread_id, is_whatsapp=False):
        try:
            ...
            print(f"[ERROR] Failed to retrieve file: {str(e)}")
            return None
    ...
    def determine_required_fields(self, task):
        try:
            ...
            print(f"[ERROR] Failed to determine required fields: {str(e)}")
    ...
    def check_what_is_empty(self, task):
        try:
            ...
            print(f"[ERROR] Failed to check what is empty: {str(e)}")
            return [], []
    ...
    def resolve_task(self, query, task, thread, user_identifier, is_whatsapp=False):
        try:
            ...
            task.update_state()
            print("estado final de la task: ", task.state)
            ...
            print(f"[ERROR] Failed to resolve task: {str(e)}")